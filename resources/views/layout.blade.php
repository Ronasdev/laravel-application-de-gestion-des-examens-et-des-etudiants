    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-success text-white">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <!-- Navbar brand -->
                <a class="navbar-brand mt-2 mt-lg-0 text-white" href="{{route('students.index')}}">Ronasdev</a>
                <!-- Left links -->
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item ">
                        <a class="nav-link text-white" href="{{route('exams.results.show')}}">Resultats</a>
                    </li>
                </ul>
                <!-- Left links -->
            </div>
